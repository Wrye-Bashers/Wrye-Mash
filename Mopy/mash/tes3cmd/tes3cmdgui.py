...
class cleanop(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"tes3cmd Clean",
            pos=wx.DefaultPosition, size=wx.Size(429, 217),
        ...
        self.m_checkBox2 = wx.CheckBox(self, wx.ID_ANY,
            u"clean cell subrecords AMBI,WHGT duped from masters",
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_checkBox2.SetValue(True)
        bSizer2.Add(self.m_checkBox2, 0, wx.ALL, 5)

        self.mCleanDups = wx.CheckBox(self, wx.ID_ANY,
            u"clean other complete records duped from masters",
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.mCleanDups.SetValue(True)
        bSizer2.Add(self.mCleanDups, 0, wx.ALL, 5)

        self.mCleanEvil = wx.CheckBox(self, wx.ID_ANY, u"clean Evil GMSTs",
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.mCleanEvil.SetValue(True)
        bSizer2.Add(self.mCleanEvil, 0, wx.ALL, 5)

        self.m_checkBox5 = wx.CheckBox(self, wx.ID_ANY,
            u"clean object instances from cells when duped from masters",
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_checkBox5.SetValue(True)
        bSizer2.Add(self.m_checkBox5, 0, wx.ALL, 5)

        self.m_checkBox6 = wx.CheckBox(self, wx.ID_ANY,
            u"clean junk cells (no new info from definition in masters)",
            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_button4 = wx.Button(self, wx.ID_ANY, u"Cancel",
            wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer3.Add(self.m_button4, 0, wx.ALL, 5)

        self.m_button5 = wx.Button(self, wx.ID_ANY, u"Clean Selected",
            wx.DefaultPosition, wx.DefaultSize, 0)
...
class cleaner(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"tes3cmd Cleaner",
            pos=wx.DefaultPosition, size=wx.Size(530, 350),
        ...
        self.mSkip = wx.Button(self.m_panel4, wx.ID_ANY, u"Skip",
            wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer14.Add(self.mSkip, 0, wx.ALL, 5)

        self.mStop = wx.Button(self.m_panel4, wx.ID_ANY, u"Stop",
            wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer14.Add(self.mStop, 0, wx.ALL, 5)

        self.mProgress = wx.Gauge(self.m_panel4, wx.ID_ANY, 100,
            wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL | wx.GA_SMOOTH)
        bSizer14.Add(self.mProgress, 0, wx.ALL, 5)

        self.m_staticText6 = wx.StaticText(self.m_panel4, wx.ID_ANY,
            u"Currently Cleaning:", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText6.Wrap(-1)
        bSizer14.Add(self.m_staticText6, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL,
            5)

        self.mCurrentFile = wx.StaticText(self.m_panel4, wx.ID_ANY,
        ...
        mCleanedModsChoices = []
        self.mCleanedMods = wx.ListBox(self.m_panel4, wx.ID_ANY,
            wx.DefaultPosition, wx.DefaultSize, mCleanedModsChoices, 0)
        ...
        self.m_staticText7 = wx.StaticText(self.m_panel4, wx.ID_ANY,
            u"Cleaning Stats:", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText7.Wrap(-1)
        fgSizer5.Add(self.m_staticText7, 0, wx.ALL, 5)

        self.mStats = wx.StaticText(self.m_panel4, wx.ID_ANY, wx.EmptyString,
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.mStats.Wrap(-1)
        ...
        self.m_notebook2 = wx.Notebook(self.m_panel4, wx.ID_ANY,
            wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_panel1 = wx.Panel(self.m_notebook2, wx.ID_ANY,
        ...
        self.mLog = wx.TextCtrl(self.m_panel1, wx.ID_ANY, wx.EmptyString,
        ...
        self.m_panel2 = wx.Panel(self.m_notebook2, wx.ID_ANY,
            wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        ...
        self.mErrors = wx.TextCtrl(self.m_panel2, wx.ID_ANY, wx.EmptyString,
            wx.DefaultPosition, wx.DefaultSize,
            wx.TE_MULTILINE | wx.TE_READONLY)
