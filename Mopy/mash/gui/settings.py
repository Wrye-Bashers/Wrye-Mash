...
class SettingsWindow(wx.MiniFrame):
    ...
    def __init__(self, parent=None, id=-1, size=(wx.DefaultSize[0], -1),
        ...
        btnBrowseInst = wx.Button(p, wx.ID_OPEN, _("..."), size=(-1, -1),
            name="btnBrowseInst")
        ...
        sizerFields.AddMany([(sizerBoxMwDir, 0, wx.EXPAND), ((0, 2)),
            (sizerBoxInstallersDir, 0, wx.EXPAND)])
    ...
    def OnBrowse(self, event):
        ...
        dialog = wx.DirDialog(self,
            _("%s directory selection") % dataMap[name].capitalize())
